...
CreateRemoteThread = func_def("CreateRemoteThread", HANDLE,
...
CreateWindowExW = func_def("CreateWindowExW", HWND, *(
    DWORD, LPCWSTR, LPCWSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HMENU, HINSTANCE, LPVOID), dll=user32)
