...
class MmmojoDll(object):
    ...
    def init_funcs(self):
        ...
        SetMMMojoEnvironmentCallbacks = self.func_def("SetMMMojoEnvironmentCallbacks", void,
                                                      *(c_void_p, c_int, py_object))
        # void SetMMMojoEnvironmentInitParams(void* mmmojo_env,int type, ...);
        SetMMMojoEnvironmentInitParams = self.func_def("SetMMMojoEnvironmentInitParams", void,
                                                       *(c_void_p, c_int, c_void_p))
        # void AppendMMSubProcessSwitchNative(void* mmmojo_env, const char* switch_string, const wchar_t* value);
        AppendMMSubProcessSwitchNative = self.func_def("AppendMMSubProcessSwitchNative", void,
        ...
        SetMMMojoWriteInfoResponseSync = self.func_def("SetMMMojoWriteInfoResponseSync", void,
